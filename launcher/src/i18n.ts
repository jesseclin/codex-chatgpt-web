...
const en = {
  ...
  closeCodexBeforeInstall: "Quit every Codex window first: Codex desktop, Codex CLI sessions, and IDE extensions. Continue?",
  launchCodexAfterInstall: "Models added. Next, start the HITL terminal (step 4) if you use local exec, then start Codex desktop or the Codex CLI yourself (fully quit it first if it is open). The chatgpt-web models appear in its model picker.",
  stepInstallHitlPending: "Models are installed. Because HITL mode is on, Codex can only load them while the HITL terminal (step 4) is running; start it, then start Codex yourself.",
  hitlBannerStarting: "Starting the HITL terminal…",
  hitlBannerWaiting: "HITL terminal is running — waiting for commands from Codex",
  hitlBannerBody: "Send a task from Codex with a chatgpt-web model; commands run in",
  hitlBannerAutoApprove: "commands run without asking",
  setupFilesChanged: "Files changed by Add models:",
  setupFilesUnchanged: "Add models finished; no configuration files needed changes.",
  setupFile_created: "Created",
  setupFile_modified: "Modified",
  setupFile_deleted: "Removed",
  stepHitl: "Start the HITL terminal",
  stepHitlBody: "Lets ChatGPT run commands in one project folder. Choose the folder, then press Start or paste the command below into a terminal. Keep that terminal open while you use Codex.",
  hitlCommandLabel: "Command to paste in a terminal",
  hitlCopy: "Copy",
  hitlCopied: "Copied",
  hitlAutoApproveLabel: "Run commands without asking",
  hitlAutoApproveBody: "Adds --hitl-auto-approve. Every command ChatGPT requests runs immediately inside the project folder, including ones that change or delete files.",
  hitlTitle: "Local exec (HITL)",
  hitlBody: "Opens a terminal running the browser-only server with human-approved local commands. Commands are confined to the workspace folder below; approve each one in the terminal or popup.",
  hitlWorkspace: "Workspace folder",
  hitlNoWorkspace: "No folder selected",
  hitlChooseWorkspace: "Choose folder",
  hitlStart: "Start HITL terminal",
  hitlRestart: "Restart HITL terminal",
  hitlRunning: "HITL server is running. Press Restart to apply a new folder or approval setting (waits until no Codex task is running), or close its terminal window to stop it.",
  hitlModeIdle: "HITL mode is on but no server is running. Start the terminal, or leave HITL mode to restore the background runtime.",
  hitlDisable: "Leave HITL mode",
  hitlBrowserOnlyRequired: "HITL requires browser-only mode.",
  hitlRestartCodexHint: "Switch the workspace by closing the terminal and starting it again with the new folder.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  closeCodexBeforeInstall: "请先关闭所有 Codex：Codex 桌面版、Codex CLI 会话与 IDE 扩展。要继续吗？",
  launchCodexAfterInstall: "模型已新增。若要使用本地执行，接着启动 HITL 终端（步骤 4），然后请自行启动 Codex 桌面版或 Codex CLI（若已开启请先完全退出）。chatgpt-web 模型会出现在模型选单中。",
  stepInstallHitlPending: "模型已安装。由于已开启 HITL 模式，Codex 只有在 HITL 终端（步骤 4）运行时才能加载这些模型；请先启动它，再自行启动 Codex。",
  hitlBannerStarting: "正在启动 HITL 终端…",
  hitlBannerWaiting: "HITL 终端运行中，正在等待 Codex 的指令",
  hitlBannerBody: "请在 Codex 中使用 chatgpt-web 模型发送任务；命令会在此文件夹执行：",
  hitlBannerAutoApprove: "命令不经询问直接执行",
  setupFilesChanged: "新增模型修改了以下文件：",
  setupFilesUnchanged: "新增模型已完成，设置文件不需要变更。",
  setupFile_created: "新建",
  setupFile_modified: "修改",
  setupFile_deleted: "删除",
  stepHitl: "启动 HITL 终端",
  stepHitlBody: "让 ChatGPT 在一个项目文件夹中执行命令。选择文件夹后按“启动”，或把下方命令粘贴到终端执行。使用 Codex 期间请保持该终端开启。",
  hitlCommandLabel: "粘贴到终端的命令",
  hitlCopy: "复制",
  hitlCopied: "已复制",
  hitlAutoApproveLabel: "不询问直接执行命令",
  hitlAutoApproveBody: "加上 --hitl-auto-approve。ChatGPT 请求的每个命令都会在项目文件夹内直接执行，包括会修改或删除文件的命令。",
  hitlTitle: "本地执行（HITL）",
  hitlBody: "打开一个终端运行 browser-only 服务器，本地命令需经人工批准。命令仅限在下方工作文件夹内执行；可在终端或弹窗中逐条批准。",
  hitlWorkspace: "工作文件夹",
  hitlNoWorkspace: "尚未选择文件夹",
  hitlChooseWorkspace: "选择文件夹",
  hitlStart: "启动 HITL 终端",
  hitlRestart: "重新启动 HITL 终端",
  hitlRunning: "HITL 服务器运行中。更改文件夹或批准设置后按“重新启动”即可套用（有 Codex 任务运行时会请你稍后再试），或关闭其终端窗口以停止。",
  hitlModeIdle: "HITL 模式已开启，但没有服务器在运行。请启动终端，或退出 HITL 模式以恢复后台运行时。",
  hitlDisable: "退出 HITL 模式",
  hitlBrowserOnlyRequired: "HITL 需要 browser-only 模式。",
  hitlRestartCodexHint: "要切换工作文件夹，请关闭终端后以新文件夹重新启动。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  closeCodexBeforeInstall: "先に Codex をすべて終了してください（Codex デスクトップ、Codex CLI のセッション、IDE 拡張機能）。続行しますか？",
  launchCodexAfterInstall: "モデルを追加しました。ローカル実行を使う場合は次に HITL ターミナル（手順 4）を起動し、その後 Codex デスクトップまたは Codex CLI をご自身で起動してください（起動中の場合は完全に終了してから）。chatgpt-web モデルがモデル選択に表示されます。",
  stepInstallHitlPending: "モデルはインストール済みです。HITL モードが有効なため、Codex は HITL ターミナル（手順 4）の実行中にのみモデルを読み込めます。先に起動してから Codex をご自身で起動してください。",
  hitlBannerStarting: "HITL ターミナルを起動しています…",
  hitlBannerWaiting: "HITL ターミナル実行中 — Codex からの指示を待っています",
  hitlBannerBody: "Codex で chatgpt-web モデルを選んでタスクを送ってください。コマンドの実行場所：",
  hitlBannerAutoApprove: "コマンドは確認なしで実行されます",
  setupFilesChanged: "モデルの追加で変更されたファイル：",
  setupFilesUnchanged: "モデルの追加が完了しました。設定ファイルの変更は不要でした。",
  setupFile_created: "作成",
  setupFile_modified: "変更",
  setupFile_deleted: "削除",
  stepHitl: "HITL ターミナルを起動",
  stepHitlBody: "ChatGPT が 1 つのプロジェクトフォルダーでコマンドを実行できるようにします。フォルダーを選んで「起動」を押すか、下のコマンドをターミナルに貼り付けてください。Codex を使う間はそのターミナルを開いたままにしてください。",
  hitlCommandLabel: "ターミナルに貼り付けるコマンド",
  hitlCopy: "コピー",
  hitlCopied: "コピーしました",
  hitlAutoApproveLabel: "確認せずにコマンドを実行",
  hitlAutoApproveBody: "--hitl-auto-approve を付けます。ChatGPT が要求したコマンドは、ファイルの変更や削除を含め、プロジェクトフォルダー内ですぐに実行されます。",
  hitlTitle: "ローカル実行（HITL）",
  hitlBody: "人の承認を経てローカルコマンドを実行する browser-only サーバーをターミナルで起動します。コマンドは下の作業フォルダー内に限定され、ターミナルまたはポップアップで 1 件ずつ承認します。",
  hitlWorkspace: "作業フォルダー",
  hitlNoWorkspace: "フォルダーが未選択です",
  hitlChooseWorkspace: "フォルダーを選択",
  hitlStart: "HITL ターミナルを起動",
  hitlRestart: "HITL ターミナルを再起動",
  hitlRunning: "HITL サーバーが実行中です。フォルダーや承認設定を変更したら「再起動」で反映できます（Codex のタスク実行中は後で再試行するよう案内します）。停止するにはターミナルウィンドウを閉じてください。",
  hitlModeIdle: "HITL モードはオンですが、サーバーが実行されていません。ターミナルを起動するか、HITL モードを終了してバックグラウンドランタイムに戻してください。",
  hitlDisable: "HITL モードを終了",
  hitlBrowserOnlyRequired: "HITL には browser-only モードが必要です。",
  hitlRestartCodexHint: "作業フォルダーを変更するには、ターミナルを閉じて新しいフォルダーで再起動してください。",
...
const ko: Record<keyof typeof en, string> = {
  ...
  closeCodexBeforeInstall: "먼저 모든 Codex를 종료하세요: Codex 데스크톱, Codex CLI 세션, IDE 확장. 계속할까요?",
  launchCodexAfterInstall: "모델을 추가했습니다. 로컬 실행을 쓰려면 다음으로 HITL 터미널(4단계)을 시작한 뒤, Codex 데스크톱이나 Codex CLI를 직접 실행하세요(이미 열려 있으면 완전히 종료한 뒤). chatgpt-web 모델이 모델 선택 목록에 나타납니다.",
  stepInstallHitlPending: "모델이 설치되었습니다. HITL 모드가 켜져 있어 Codex는 HITL 터미널(4단계)이 실행 중일 때만 모델을 불러올 수 있습니다. 먼저 시작한 뒤 Codex를 직접 실행하세요.",
  hitlBannerStarting: "HITL 터미널을 시작하는 중…",
  hitlBannerWaiting: "HITL 터미널 실행 중 — Codex의 명령을 기다리는 중",
  hitlBannerBody: "Codex에서 chatgpt-web 모델로 작업을 보내세요. 명령 실행 위치:",
  hitlBannerAutoApprove: "명령이 묻지 않고 실행됩니다",
  setupFilesChanged: "모델 추가로 변경된 파일:",
  setupFilesUnchanged: "모델 추가를 마쳤습니다. 설정 파일은 변경할 필요가 없었습니다.",
  setupFile_created: "생성",
  setupFile_modified: "수정",
  setupFile_deleted: "삭제",
  stepHitl: "HITL 터미널 시작",
  stepHitlBody: "ChatGPT가 한 프로젝트 폴더에서 명령을 실행할 수 있게 합니다. 폴더를 선택한 뒤 시작을 누르거나 아래 명령을 터미널에 붙여 넣으세요. Codex를 쓰는 동안 그 터미널을 열어 두세요.",
  hitlCommandLabel: "터미널에 붙여 넣을 명령",
  hitlCopy: "복사",
  hitlCopied: "복사됨",
  hitlAutoApproveLabel: "묻지 않고 명령 실행",
  hitlAutoApproveBody: "--hitl-auto-approve를 추가합니다. ChatGPT가 요청한 모든 명령이 파일 변경이나 삭제를 포함해 프로젝트 폴더 안에서 바로 실행됩니다.",
  hitlTitle: "로컬 실행(HITL)",
  hitlBody: "사람의 승인을 거쳐 로컬 명령을 실행하는 browser-only 서버를 터미널에서 엽니다. 명령은 아래 작업 폴더로 제한되며, 터미널이나 팝업에서 하나씩 승인합니다.",
  hitlWorkspace: "작업 폴더",
  hitlNoWorkspace: "선택된 폴더 없음",
  hitlChooseWorkspace: "폴더 선택",
  hitlStart: "HITL 터미널 시작",
  hitlRestart: "HITL 터미널 다시 시작",
  hitlRunning: "HITL 서버가 실행 중입니다. 폴더나 승인 설정을 바꾼 뒤 다시 시작을 누르면 적용됩니다(Codex 작업이 실행 중이면 나중에 다시 시도하라고 안내합니다). 중지하려면 터미널 창을 닫으세요.",
  hitlModeIdle: "HITL 모드가 켜져 있지만 실행 중인 서버가 없습니다. 터미널을 시작하거나 HITL 모드를 종료해 백그라운드 런타임으로 돌아가세요.",
  hitlDisable: "HITL 모드 종료",
  hitlBrowserOnlyRequired: "HITL에는 browser-only 모드가 필요합니다.",
  hitlRestartCodexHint: "작업 폴더를 바꾸려면 터미널을 닫고 새 폴더로 다시 시작하세요.",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  closeCodexBeforeInstall: "請先關閉所有 Codex：Codex 桌面版、Codex CLI 工作階段與 IDE 擴充功能。要繼續嗎？",
  launchCodexAfterInstall: "模型已新增。若要使用本機執行，接著啟動 HITL 終端（步驟 4），然後請自行啟動 Codex 桌面版或 Codex CLI（若已開啟請先完全結束）。chatgpt-web 模型會出現在模型選單中。",
  stepInstallHitlPending: "模型已安裝。由於已開啟 HITL 模式，Codex 只有在 HITL 終端（步驟 4）執行時才能載入這些模型；請先啟動它，再自行啟動 Codex。",
  hitlBannerStarting: "正在啟動 HITL 終端…",
  hitlBannerWaiting: "HITL 終端執行中，正在等待 Codex 的指令",
  hitlBannerBody: "請在 Codex 中使用 chatgpt-web 模型送出任務；指令會在此資料夾執行：",
  hitlBannerAutoApprove: "指令不經詢問直接執行",
  setupFilesChanged: "新增模型修改了以下檔案：",
  setupFilesUnchanged: "新增模型已完成，設定檔不需要變更。",
  setupFile_created: "新增",
  setupFile_modified: "修改",
  setupFile_deleted: "刪除",
  stepHitl: "啟動 HITL 終端",
  stepHitlBody: "讓 ChatGPT 在一個專案資料夾中執行指令。選擇資料夾後按「啟動」，或把下方指令貼到終端機執行。使用 Codex 期間請保持該終端機開啟。",
  hitlCommandLabel: "貼到終端機的指令",
  hitlCopy: "複製",
  hitlCopied: "已複製",
  hitlAutoApproveLabel: "不詢問直接執行指令",
  hitlAutoApproveBody: "加上 --hitl-auto-approve。ChatGPT 要求的每個指令都會在專案資料夾內直接執行，包括會修改或刪除檔案的指令。",
  hitlTitle: "本機執行（HITL）",
  hitlBody: "開啟一個終端機執行 browser-only 伺服器，本機指令需經人工批准。指令只能在下方的工作資料夾內執行；可在終端機或彈窗中逐一批准。",
  hitlWorkspace: "工作資料夾",
  hitlNoWorkspace: "尚未選擇資料夾",
  hitlChooseWorkspace: "選擇資料夾",
  hitlStart: "啟動 HITL 終端機",
  hitlRestart: "重新啟動 HITL 終端",
  hitlRunning: "HITL 伺服器執行中。變更資料夾或批准設定後按「重新啟動」即可套用（有 Codex 任務執行時會請你稍後再試），或關閉它的終端機視窗以停止。",
  hitlModeIdle: "HITL 模式已開啟，但沒有伺服器在執行。請啟動終端機，或離開 HITL 模式以恢復背景執行環境。",
  hitlDisable: "離開 HITL 模式",
  hitlBrowserOnlyRequired: "HITL 需要 browser-only 模式。",
  hitlRestartCodexHint: "要切換工作資料夾，請關閉終端機後用新的資料夾重新啟動。",
